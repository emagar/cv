...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fbox{\parbox{\textwidth}{
    \bibentry{magar.2007ref.2015} (\href{https://jhupbooks.press.jhu.edu/title/mexicos-evolving-democracy}{\footnotesize{ISBN:9781421415543}}). \textbf{\color{red}\ref{ncites:magar.2007ref.2015}~cita.}
}}
        \begin{CitasMiTrabajo}
        %  pyg
        \item \bibentry{beltran.cornejo.Clientelismo.2019} (\textbf{México}). $\rightarrow$ \href{http://www.politicaygobierno.cide.edu/index.php/pyg/article/view/1297/988}{prueba p. 190}

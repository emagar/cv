...
\noindent Hasta el 12 de marzo 2020, he documentado \textbf{\color{red} \calc{
  ...
  \getrefnumber{ncites:magar.romero.timmons.2009}+
  ...
  \getrefnumber{ncites:magar.aldf.2017.rucp}+
  \getrefnumber{ncites:magar-palanza-sin2021jop}
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
%% %% Magar Palanza Sin 2021 jop %% %%
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fbox{\parbox{\textwidth}{
    \bibentry{magar-palanza-sin2021jop} (\href{https://doi.org/10.1086/710015}{\footnotesize{https://doi.org/10.1086/710015}}). 
\textbf{\color{red}\ref{ncites:magar-palanza-sin2021jop} cita}.
% DOI: http://dx.doi.org/10.1016/j.polgeo.2016.11.015
}}
        \begin{CitasMiTrabajo}
        %  no tengo pdf
        \item \bibentry{valdivieso.huertas.Overrides2024prq} (\textbf{EE.UU.}). $\rightarrow$ \href{https://doi.org/10.1177/10659129241268822}{prueba}

        \item \bibentry{keena.2019} (\textbf{Polonia}). $\rightarrow$ \href{https://doi.org/10.7206/DEC.1733-0092.130}{prueba}

          \label{ncites:magar-palanza-sin2021jop} % place this label after last item to record the number of cites for cross-referencing

        \end{CitasMiTrabajo}

%% Data science meets political economy: applications to legislative favouritism around the world
%% Benoit, Cyril; Brenner, Dominik; Fazekas, Mihaly
...
% DOI: http://dx.doi.org/10.1016/j.polgeo.2016.11.015
        ...
        \begin{CitasMiTrabajo}
        %  tengo pdf, también en https://journal.kozminski.edu.pl/index.php/decyzje/article/view/388/0
        \item \bibentry{keena.2019} (\textbf{Polonia}). $\rightarrow$ \href{https://github.com/emagar/cv/blob/master/citasMiTrab/magar-etal-2017polgeo/keena2019.pdf}{prueba}
          
        %  jop c2020 preprint:oct2020
        \item \bibentry{walter-emmenegger-Swiss-gerrymandering2020jop} (\textbf{EE.UU.}). $\rightarrow$ \href{https://www.journals.uchicago.edu/doi/10.1086/711059}{prueba}
...
\fbox{\parbox{\textwidth}{
    \bibentry{trelles.etalDatosabiertos.pyg.2016} (\href{https://openscholar.mit.edu/sites/default/files/dept/files/825-1508-1-pb_en.pdf}{\footnotesize{ISSN:1665-2037}}). \textbf{\color{red}\ref{ncites:trellesEtAl2016pyg}~citas}
        ...
        \item \bibentry{luna.2018} (\textbf{Brasil}). $\rightarrow$ \href{https://www.revistas.usp.br/leviathan/article/view/144961}{prueba}
          ...
          % Need proof
          % Levin, Harry A. The Rise of the Hal-mander: Is Gerrymandering by Algorithm the Next Frontier of Partisan Gerrymandering? Georgetown Law Journal
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Magar 2017 ALDF in RUCP   %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fbox{\parbox{\textwidth}{
    \bibentry{magar.aldf.2017} (\href{http://www.scielo.edu.uy/scielo.php?pid=S1688-499X2017000100035&script=sci_arttext}{\footnotesize{ISSN 0797-9789}}). \textbf{\color{red}\ref{ncites:magar.aldf.2017.rucp}~cita}
}}
        \begin{CitasMiTrabajo}
        %  link to paper
        \item \bibentry{tellez-del-rio.2018} (\textbf{M\'exico}). $\rightarrow$~\href{https://github.com/emagar/cv/blob/master/citasMiTrab/magarALDF2017rucp/tellez-del-rio-Tesina-cide-2018.pdf}{prueba}

        \label{ncites:magar.aldf.2017.rucp} % place this label after last item to record the number of cites for cross-referencing
...
%% Los escenarios electoral e ideológico en el sistema de partidos mexicano. Una mirada posterior a la elección 2018
%% Citing book
%% Jul 2019
%% Oniel Francisco Díaz Jiménez · Luis Eduardo Leon Ganatios
...
%\href{https://doi.org/10.1080/13510347.2016.1222373}{prueba}
        ...
        %% Larger Legislatures and the Cost of Political Brokerage: Evidence from Brazil
        %% Frey, Anderson
        %% Journal Of Politics

        %% Intergovernmental alignment and the electoral value of mayors: reverse coattails in an unexpected technocracy
        %% Savu, Alexandru
        %% Public Choice

        % Institutional opportunism: How electoral fortunes shape preferences for power-sharing institutions in Latin America
        % Alles, Santiago
        % Legislative Studies Quarterly

        %% Provincial Election Dates and National Politics in Argentina (1985-2023)
        %% Lacher, Andres Revista Saap
        \end{CitasMiTrabajo}
...
\fbox{\parbox{\textwidth}{
    \bibentry{magar.moraes.2012pp} (\href{http://dx.doi.org/10.1177/1354068810377460}{\footnotesize{ISSN:1354-0688}}). \textbf{\color{red}\ref{ncites:magar.moraes.2012pp}~citas}
        ...
        % tengo pdf
        \item \bibentry{varshavsky.2019} (\textbf{Rusia}). $\rightarrow$ \href{https://github.com/emagar/cv/blob/master/citasMiTrab/magarMoraesPP/varshavsky2019.pdf}{prueba}
          
        \label{ncites:magar.moraes.2012pp} % place this label after last item to record the number of cites for cross-referencing

% A Coalesc?ncia Revisitada: O C?lculo Presidencial no
% Couto, Lucas; Albala, Adrian
...
%% Citing article
%% Jun 2020 · Revista Uruguaya de Ciencia Política
%% Daniel Buquet · Nicolás Schmidt · Juan A Moraes
        
%%% Quiz\'as nos cite Anal Laura en Nexos vol 30  num 369 sept 2008.
%%
%% Ezequiel Gonzalez-Ocantos forthcoming Communicative Entrepreneurs: The Case of the Inter-American Court of Human Rights’ Dialogue with National Judges International Studies Quarterly
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fbox{\parbox{\textwidth}{
    \bibentry{magar.romero.timmons.2009} (\href{http://ssrn.com/abstract=1963863}{\footnotesize{obt\'enlo}}). \textbf{\color{red}\ref{ncites:magar.romero.timmons.2009}~citas}
}}

        \begin{CitasMiTrabajo}
        
        % link to www
        \item \bibentry{serra-pemex-2017} (\textbf{Suiza}). $\rightarrow$ \href{https://www.academia.edu/34900687/Serra_Gilles._2017._Congressional_Negotiations_with_Costly_Voting_Understanding_the_Reforms_to_PEMEX_in_2006-2008._In_State_Institutions_and_Democracy_Contributions_of_Political_Economy_edited_by_Norman_Schofield_and_Gonzalo_Caballero._New_York_Springer_295-326?email_work_card=view-paper}{prueba en p. 47}

        % link to www
        \item \bibentry{fairfield-garay-2017} (\textbf{EE.UU.}). $\rightarrow$ \href{https://doi.org/10.1177/0010414017695331}{prueba}
          
        \label{ncites:magar.romero.timmons.2009} % place this label after last item to record the number of cites for cross-referencing
...
\fbox{\parbox{\textwidth}{
    \bibentry{estevez.magar.rosas.2008} (\href{https://github.com/emagar/cv/blob/master/papers/EstevezMagarRosasIFEElecStud2008.pdf}{\footnotesize{ISSN:0261-3794}}). \textbf{\color{red}\ref{ncites:estevez.magar.rosas.2008}~citas}
       ...
       \item Tarouco, G. (2015)
        ...
        %  tengo pdf
        \item \bibentry{faustino.2015} (\textbf{M\'exico}).  $\rightarrow$~\href{https://github.com/emagar/cv/blob/master/citasMiTrab/estevezEtalElecStud/faustino-torres-ife-disenho2015ep.pdf}{prueba}
        
        %  FALTA COMPLETAR Y PRUEBA
%
%       verificar si nos cita
%       Víctor A. Hernández-Huerta Disputed Elections in Presidential Democracies: Contexts of Electoral Blackmail  jop Volume 82, Number 1 January 2020
        %
...
%%
% When Do Voters See Fraud? Evaluating the Effects of Poll Supervision on Perceptions of Integrity
% Mbozi, Fanisi
...
\fbox{\parbox{\textwidth}{
    \bibentry{magar.romero.2008} (\href{http://www.scielo.cl/scielo.php?script=sci_arttext&pid=S0718-090X2008000100013&lng=es&nrm=iso}{\footnotesize{ISSN:0716-1417}}). \textbf{\color{red}\ref{ncites:magar.romero.2008}~citas}
        ...
        %  tengo pdf
        \item \bibentry{miranda.2019} (\textbf{México}). $\rightarrow$ \href{https://github.com/emagar/cv/blob/master/citasMiTrab/magarRomero2008/miranda2019.pdf}{prueba}
...
%%
%%       Party Effects in State Legislative Committees	McGrath R.J., Ryan J.M.	2019	Legislative Studies Quarterly.
%%
        %% Bonica, A. (2016). Avenues of influence: On the political expenditures of corporations and their directors and executives. Business and Politics, 18(4), 367-394. doi:10.1515/bap-2016-0004%%
%%
        %% Either with Us or Against Us: Business Power and Campaign Contributions in an Age of Hyper-Partisanship Selling, Niels Political Research Quarterly
%%        
...
%\href{https://github.com/emagar/cv/blob/master/citasMiTrab/mrs/jonesSSQ99.pdf}{prueba}
        ...
        % La transformación de votos en escaños: leyes electorales en Chile, 1833-2004 by Patricio Navia

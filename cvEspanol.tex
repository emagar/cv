...
\subsection{En revistas arbitradas}
    ...
    \item \href{https://ssrn.com/abstract=3514866}{``Presidents on the Fast Track: Fighting Floor Amendments with Restrictive Rules''} con Valeria Palanza y Gisela Sin, \href{https://www.journals.uchicago.edu/doi/abs/10.1086/710015}{\emph{Journal of Politics}} (aceptado en junio 2019).% \textbf{\color{red}\ref{ncites:magar-palanza-sin2020jop} citas documentadas}}.
...
\subsection{Cap\'itulos en vol\'umenes colectivos}
    ...
    \item \href{https://github.com/emagar/cv/blob/master/papers/magarDebateDips2021oup.pdf}{``Mexico: Parties and floor access in Mexico's C\'amara de Diputados''} in \emph{The Politics of Legislative Debate around the World}, coord.\ por Hanna B\"ack, Marc Debus y Jorge M. Fernandes (Oxford: Oxford University Press, 2021, ch.\ 28, pp.\ , ISBN ).  %\textbf{\color{red}\ref{ncites:magar.debate.dips.2021} citas documentadas}}.

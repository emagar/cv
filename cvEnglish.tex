...
\begin{itemize}
   \item \href{https://github.com/emagar/elecRetrns/blob/master/papers/data-descriptives/deep-description-04-mex-studies.pdf}{``Local Competition in Mexican Politics since 1979: A Comprehensive Dataset of Municipal Elections''}, \emph{Mexican Studies/Estudios Mexicanos} (submitted Dec.\ 2025).
      
    \item \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4693247}{``Institutions Matter, Lines Don't: Unveiling Mexico's Redistricting Process''} with Alejandro Trelles, Micah Altman, and Michael P.\ McDonald, \emph{Journal of Latin American Studies} (Revise and Resubmit received Sep.\ 2024).
...
\begin{itemize}
   ...
   \item ``Roll Call Votes in the Mexican Senate'' repository, \url{https://github.com/emagar/senmex}, GitHub 28 Mar.\ 2025 (last updated 31 Mar.\ 2025). 
...
\item 6 Nov.\ 2025, discussant of the book \emph{Unity through Particularism} by Lucía Motolinia, ITAM Mexico City.

\item 28 Mar.\ 2025, ``Data in Memory of Francisco Cantú'' at the \emph{Empirical Implications of Theoretical Models} conference, University of Houston.

\item 6 Mar.\ 2025, ``La elección general de 2025 en Alemania'' at the conference \emph{Elecciones en Alemania y su impacto global}, Centro Alonso Lujambio, ITAM.

\item 4 Dec.\ 2024, ``Gerrymandering en Estados Unidos: Balance de la misión de observación de las elecciones de EE.UU. 2024'', Dept. of Political Science, ITAM.
  
\item 4 Nov.\ 2024, ``Las elecciones en EE.UU.'' at the \emph{Harris o Trump: consecuencias para México} conference, ITAM. 
...
\item 2024, Electoral Boundaries Specialist of the

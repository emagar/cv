...
\subsection{In peer-reviewed journals}
    ...
    \item ``No Accountability without Transparency and Consistency: Evaluating Mexico's Redistricting-by-Formula'' with Alejandro Trelles, Micah Altman y Michael P.\ McDonald, forthcoming in \emph{Election Law Journal} (2023).  
% ISSN: 1533-1296 | Online ISSN: 1557-8062 | Published Quarterly
  ...
  \item \href{https://doi.org/10.1086/710015}{``Presidents on the Fast Track: Fighting Floor Amendments with Restrictive Rules''} with Valeria Palanza and Gisela Sin, \emph{The Journal of Politics}  vol.~83, num.~2 (2021) pp.~633--46. %https://ssrn.com/abstract=3514866 (\href{https://doi.org/10.1086/710015}{https://doi.org/10.1086/710015}). 
    ...
    \item \href{https://github.com/emagar/cv/blob/master/papers/cox-magar1999apsr.pdf}{``How Much is Majority Status in the U.S. Congress Worth?''} with Gary W.\ Cox, \href{http://www.jstor.org/pss/2585397}{\emph{American Political Science Review}} vol.\ 93, num.\ 2 (June 1999), pp.\ 299--309.
        ...
        \item \href{https://github.com/emagar/cv/blob/master/papers/cox-magar-Corrigendum2022apsr.pdf}{``How Much is Majority Status in the U.S. Congress Worth? --- CORRIGENDUM''} with Gary W.\ Cox, \href{https://www.cambridge.org/core/journals/american-political-science-review}{\emph{American Political Science Review}} forthcoming\condcomment{\boolean{longcv}}{ (ISSN:0003-0554, \url{https://doi.org/10.1017/S000305542200123X})}. 
...
\begin{itemize}
   ...
   \item ``Nighttime Lights in Mexico at Units of Substantive Interest'' repository, \url{https://github.com/emagar/luminosity}, GitHub.
  
   \item ``Recent Mexican Electoral Geography'' repository, \url{https://github.com/emagar/mxDistritos}, GitHub.
  
   \item ``Recent Mexican Election Vote Returns'' repository, \url{https://github.com/emagar/elecRetrns}, GitHub. 
